#!/bin/bash
# Phase B: prefer downward split / defer root expand vs alex + maxleaf512.
set -euo pipefail
cd /home/GRE_Longitudinal

OUT_DIR=./results/exploratory/alex_phase_b
...
INDEXES=(
  ...
  alex_pref_down
  alex_defer_root
  alex_maxleaf512_down
  alex_maxleaf512_down_norooot
)

rm -f "$CSV"

for idx in "${INDEXES[@]}"; do
  log="${LOG_DIR}/alex_phase_b_${idx}_libio_5m_seed${SEED}.log"
  {
    echo ""
    echo "======================================================================"
