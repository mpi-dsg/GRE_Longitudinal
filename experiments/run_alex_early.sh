#!/bin/bash
# Early-split / expand-cap localization suite vs stock alex (+ btree).
set -euo pipefail
cd /home/GRE_Longitudinal

OUT_DIR=./results/exploratory/alex_early
...
# Reuse ops cache from prior localize suite if present for fair compare
...
for idx in "${INDEXES[@]}"; do
  log="${LOG_DIR}/alex_early_${idx}_libio_5m_seed${SEED}.log"
  {
    echo ""
    echo "======================================================================"
...
echo "All early-split runs finished. CSV=${CSV}"
