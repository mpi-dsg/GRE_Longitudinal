#!/bin/bash
# Smoke: blade vs alex vs btree on libio 5M growth protocol.
set -euo pipefail
cd /home/GRE_Longitudinal

OUT_DIR=./results/exploratory/blade_smoke
...
INDEXES=(alex btree blade blade128 blade512)

rm -f "$CSV"

for idx in "${INDEXES[@]}"; do
  log="${LOG_DIR}/blade_smoke_${idx}_libio_5m_seed${SEED}.log"
  {
    echo ""
    echo "======================================================================"
...
echo "BLADE smoke finished. CSV=${CSV}"
