#!/bin/bash
# Phase A hypothesis test: hard max leaf keys vs stock alex (+ btree).
set -euo pipefail
cd /home/GRE_Longitudinal

OUT_DIR=./results/exploratory/alex_phase_a
...
for idx in "${INDEXES[@]}"; do
  log="${LOG_DIR}/alex_phase_a_${idx}_libio_5m_seed${SEED}.log"
  {
    echo ""
    echo "======================================================================"
