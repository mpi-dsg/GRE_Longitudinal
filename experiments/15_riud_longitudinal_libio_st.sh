...
MASTER_LOG="${LOG_DIR}/riu_longitudinal_libio_st_r30i40u20d10.log"
...
for seed in "${SEEDS[@]}"; do
  export SEED="$seed"
  csv="${RESULTS_DIR}/riu_longitudinal_libio_st_r30i40u20d10_seed${seed}.csv"
  ops_name="riu_longitudinal_libio_r30i40u20d10_seed${seed}"
  rm -f "$csv"
